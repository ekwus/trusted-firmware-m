 ...
 * blackbox_partition. The SAU's NON_SECURE_LIMIT in target_cfg.c is derived
 * from FLASH_AREA_END_OFFSET (and so are BL2's MPU regions 2 and 10 and
 * BL2's SAU region 1), so every NS-accessible area must be inside it or NS
 * access faults.
 *
